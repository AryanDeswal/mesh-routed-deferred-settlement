...
A Spring Boot backend that demonstrates **offline payments routed through a Bluetooth-style mesh network**. You're in a basement with zero connectivity. You send your friend ₹500. Your phone encrypts the payment, broadcasts it to nearby phones, and the packet hops device-to-device until *some* phone walks outside, gets 4G, and silently uploads it to this backend. The backend decrypts, deduplicates, and settles.
...
3. [The demo flow](#the-demo-flow)
4. [Architecture](#architecture)
5. [Problems and how they're solved](#problems-and-how-theyre-solved)
...
10. [Limitations of the concept](#limitations-of-the-concept)
